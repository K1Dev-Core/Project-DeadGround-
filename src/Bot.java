...
public class Bot {
    double x, y;
    int hp = Config.BOT_HP;
    double angle = 0;
    int speed = Config.BOT_SPEED;
    BufferedImage stand, walk;
    ...
    int w() { return stand.getWidth(); }
    int h() { return stand.getHeight(); }

    public void update(Player player, java.util.List<Rectangle2D.Double> collisions, int mapW, int mapH) {
    ...
    public Rectangle2D.Double bounds() { return new Rectangle2D.Double(x, y, w(), h()); }
